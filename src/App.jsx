...
export default function App() {
  ...
  async function handleArcCoachCreated({ block, habitsPatch }) {
    ...
    <>
      ...
      {showArcCoach && (
        <ArcCoachSheet
          ...
          onCreated={handleArcCoachCreated}
