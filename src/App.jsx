...
export default function App() {
  ...
  return (
    <>
      ...
      {showArcCoach && (
        <ArcCoachSheet
          onClose={() => setShowArcCoach(false)}
          onUseFormInstead={() => { setShowArcCoach(false); setShowArcSetup(true); }}
          onCreated={async () => {
            setShowArcCoach(false);
            await reloadForgeBlocks();
