    ...
    const resp = await client.messages.create({
      ...
      system: [{
        ...
        text:
          ...
          "- structured: { \"wins\": [..], \"hard_parts\": [..], \"slips\": [..], \"mood\": string|null, \"tomorrow_focus\": string|null } — short, natural phrases a person would actually say (\"Played poker with friends\", not \"Engaged in social recreation\"), empty arrays when nothing fits. `wins` specifically gets shown verbatim in tomorrow's morning greeting as bullet points — write each one as a complete, specific, human phrase on its own.\n" +
