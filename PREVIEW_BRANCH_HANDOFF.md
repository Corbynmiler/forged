...
**Last updated:** 2026-07-05 (second round today) — after the voice pipeline was confirmed working better, the user approved a larger push: a long-form conversation mode, surfacing the AI-judged XP separately, retiring the old modal coach drawer, and renaming Coach→Companion in UI copy. Three of four shipped; the personality fix is blocked on a real safety gate — see below.
